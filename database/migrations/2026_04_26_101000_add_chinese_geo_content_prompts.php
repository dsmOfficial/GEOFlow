...
10. 不要输出写作说明、字数说明、前言提示语，也不要出现“好的，”“文章如下。”“根据您的要求生成……”“作为……我将输出……”等确认语或角色前言。
...
请直接输出最终文章正文（Markdown），从标题或第一段正文开始写；禁止确认语、角色前言和写作过程说明。
PROMPT,
                'variables' => '',
                'created_at' => $now,
                'updated_at' => $now,
...
8. 不要输出写作说明、占位符解释，也不要出现“好的，”“文章如下。”“根据您的要求生成……”“作为……我将输出……”等确认语或角色前言。
...
请直接输出最终榜单文章（Markdown），从标题或第一段正文开始写；禁止确认语、角色前言和写作过程说明。
PROMPT,
                'variables' => '',
                'created_at' => $now,
                'updated_at' => $now,
