...
- 直接输出最终 Markdown 正文，不要输出提纲说明、占位符或证据编号（如 [K1]）
...
PROMPT;
    ...
    {
        return <<<PROMPT
你是一位资深全栈开发者，正在给同行写一篇关于完整项目的技术实践文章。
...
PROMPT;
    ...
    {
        return <<<PROMPT
你是一位独立创业者/独立开发者，正在分享如何用更小团队做出完整项目并交付上线。
...
PROMPT;
    ...
    {
        return <<<PROMPT
你是一位 CTO / 技术负责人，正在写给技术管理与架构决策者的项目评估文章。
...
PROMPT;
    ...
    {
        return <<<PROMPT
你是一位行业顾问，正在撰写给客户/决策层看的项目方案解读文章。
